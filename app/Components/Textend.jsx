...
export default function Textend(){
...
<div className="difr">
           <div className="as">
         <div className="hed">
            <h1>با دوره‌های سبزلرن برنامه‌نویس حرفه‌ای شوید!</h1>
